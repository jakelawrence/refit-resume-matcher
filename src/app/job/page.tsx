...
export default function HomePage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const selectedResumeIds = JSON.parse(selectedResumeIdsRaw);
      if (!Array.isArray(selectedResumeIds) || selectedResumeIds.length === 0) {
        throw new Error("Please select at least one résumé in Step 1.");
      }

      // Store parsed result and score selected resumes
      ...
      if (!scoreRes.ok || !scoreJson.success) {
        throw new Error(scoreJson.error ?? "Scoring failed.");
      }

      const serializedResults = JSON.stringify(scoreJson.data);
          ...
          <div className="card-inner">
            <div className="card-header">
              ...
              <p className="card-subtitle">
                Copy the full text of any job listing and paste it below. We will extract every requirement, skill, and keyword automatically.
              </p>
            </div>
